...
create policy "read savings" on savings for select using (true);
create policy "read overseas_holdings" on overseas_holdings for select using (true);
create policy "read rebal_history" on rebal_history for select using (true);
create policy "read isa_history" on isa_history for select using (true);
create policy "read isa_holdings" on isa_holdings for select using (true);
create policy "read crypto_holdings" on crypto_holdings for select using (true);
create policy "read crypto_history" on crypto_history for select using (true);
create policy "read real_estate" on real_estate for select using (true);
create policy "read yearly_records" on yearly_records for select using (true);
